...
import { Alert, AlertText, Modal, ModalBackdrop } from '@gluestack-ui/themed';
    ...
    const login = () => {
        ...
        .catch((error) => {
            ...
            if (errorCode === 'auth/wrong-password') {
                toggleAlert('Password salah. Harap periksa kembali dan coba lagi.');
            } else {
    ...
    return (
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#EDE4D3'}}>
          ...
          <Modal isOpen={showAlert} onClose={() => toggleAlert()}>
            <ModalBackdrop />
            <Alert mx="$4" action="error" variant="solid" bg="floralwhite">
  <AlertText fontWeight="$bold">Error!</AlertText>
  <AlertText>Password / Email Tidak Sesuai</AlertText>
</Alert>
          </Modal>
        )}

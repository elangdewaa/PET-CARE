...
import { Button, ButtonText, Heading, Image, Modal, ModalBackdrop, ModalContent, ModalHeader, ModalFooter, ModalBody, AlertText, Alert,} from "@gluestack-ui/themed";
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#EDE4D3" }}>
      <View style={{ padding: 24, flexGrow: 1, flexShrink: 1, flexBasis: 0 }}>
        <View style={{ marginVertical: 36 }}>
          ...
          >
            Solusi aman untuk hewan peliharaan
          </Text>
        </View>

        <View style={{ marginBottom: 24 }}>
          <View style={{ marginBottom: 16 }}>
            <Text style={{ fontSize: 17, fontWeight: "600", color: "#222", marginBottom: 8 }}>Alamat Email</Text>
            <TextInput
              autoCapitalize="none"
              autoCorrect={false}
          ...
          <View style={{ marginBottom: 16 }}>
            <Text style={{ fontSize: 17, fontWeight: "600", color: "#222", marginBottom: 8 }}>Password</Text>
            <TextInput
              autoCorrect={false}
